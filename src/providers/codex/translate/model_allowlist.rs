...
mod tests {
    ...
    #[test]
    fn stable_gpt_aliases_resolve_to_current_codex_models() {
        assert_eq!(resolve_model_request("gpt-5").model, "gpt-5.5");
        assert_eq!(resolve_model_request("gpt-5-mini").model, "gpt-5.4-mini");
        assert_eq!(resolve_model_request("gpt-5-codex").model, "gpt-5.3-codex");
    }
